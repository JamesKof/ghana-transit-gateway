...
const galleryCategories = [
  {
    ...
    images: [
      {
        id: 1,
        title: "Border Control Operations",
        description: "GIS officers conducting border security checks",
        category: "operations",
      },
      {
        id: 2,
        title: "Immigration Services",
        description: "Providing efficient visa and permit services",
        category: "operations",
      },
      {
        id: 3,
        title: "Document Processing",
        description: "Processing travel documents and permits",
        category: "operations",
      },
    ],
  },
    ...
    images: [
      {
        ...
        description: "Comprehensive training for immigration officers",
        category: "training",
      },
      {
        id: 5,
      ...
      },
      {
        ...
        description: "Advanced technology training sessions",
        category: "training",
      },
    ],
  },
    ...
    images: [
      {
        ...
        description: "GIS annual awards and recognition ceremony",
        category: "events",
      },
      {
        id: 8,
    ...
    images: [
      {
        ...
        description: "Main headquarters in Ridge, Accra",
        category: "facilities",
      },
      {
        id: 11,
        title: "Regional Offices",
        description: "Regional command centers across Ghana",
        category: "facilities",
      },
      {
        id: 12,
        title: "Border Posts",
        description: "Modern border control facilities",
        category: "facilities",
      },
    ],
  },
