...
const feedbackSchema = z.object({
  ...
  feedback_type: z.enum(["complaint", "suggestion", "inquiry", "commendation"]),
...
interface RegionalFeedbackFormProps {
  region: string;
}

export const RegionalFeedbackForm = ({ region }: RegionalFeedbackFormProps) => {
